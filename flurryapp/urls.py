...
drivers_routers = router.register(
    r'drivers', viewsets.DriverViewSet, base_name='drivers')

drivers_routers.register(r'cars', viewsets.CarViewSet,
                         base_name='driver-cars', parents_query_lookups=['owner'])

drivers_routers.register(r'profiles', viewsets.ProfileViewSet,
                         base_name='driver-profiles', parents_query_lookups=['driver'])
